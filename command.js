...
whois = [
    "<a style='color: #ffffff'>Namaste, I'm Joshua Thadi!",
    "<a style='color: #ffffff'>I am a computer science student, currently working on and developing my programming skills.",
    "<a style='color: #ffffff'>I only like perfection!",
    "<a style='color: #ffffff'>An AI/ML, Data Science, and Web Design enthusiast, passionate about building intelligent systems,",
    "<a style='color: #ffffff'>analyzing data, and crafting innovative web experiences.",
    "<br>"
];
...
neofetch = [
    ...
    .ossssssssssssssssss<a style='color: #ffffff'>dMMMNy</a>sssso.       <a style='color: #ffffff'>bezehel@k.@MasterJudah</a> 
...
asciiart = [
    ...
    '<span class="command">masterjudah</span>       creator of the website',
